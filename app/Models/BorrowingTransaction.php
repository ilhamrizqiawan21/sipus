...
#[Fillable(['transaction_code', 'member_id', 'member_code_snapshot', 'member_name_snapshot', 'member_class_snapshot', 'member_type_snapshot', 'borrow_date', 'due_date', 'status', 'processed_by', 'notes'])]
class BorrowingTransaction extends Model
{
    ...
    public function fines() { return $this->hasMany(Fine::class, 'borrowing_transaction_id'); }
